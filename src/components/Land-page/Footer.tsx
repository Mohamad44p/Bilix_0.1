...
export default function FooterSection() {
  return (
    <footer className="border-t border-gray-200 dark:border-gray-700 bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 text-gray-900 dark:text-white pt-20 transition-colors duration-300">
      <div className="mb-8 border-b border-gray-200 dark:border-gray-700 md:mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            {[
              ...
              <motion.a
                ...
                className="text-gray-500 dark:text-gray-400 hover:text-primary dark:hover:text-primary block transition-colors duration-200"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="grid gap-12 md:grid-cols-5 md:gap-0 lg:grid-cols-4">
          ...
          <motion.form
            className="row-start-1 border-b border-gray-200 dark:border-gray-700 pb-8 text-sm md:col-span-2 md:border-none lg:col-span-1"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="h-8 text-sm bg-transparent border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white"
                />
                <Button
                  size="sm"
        ...
        <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t border-gray-200 dark:border-gray-700 py-6">
          <small className="text-gray-500 dark:text-gray-400 order-last block text-center text-sm md:order-first">
          ...
          <form action="">
            <div className="relative">
              ...
              <select
                className={cn(
                  "border-gray-200 dark:border-gray-700 file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground shadow-xs flex h-9 w-full min-w-32 appearance-none rounded-md border bg-transparent px-3 py-1 text-base outline-none transition-[color,box-shadow] file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
